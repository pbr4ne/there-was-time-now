...
const unlockList : any = reactive({
  ...
  [ScienceKey.CHRONOCRYSTALS]: new Unlock(UnlockKey.SCIENCE, ScienceKey.CHRONOCRYSTALS, PersonKey.LENNOX_OLD, 10, null!),

  [ScienceKey.BIOLOGY]: new Unlock(UnlockKey.SCIENCE, ScienceKey.BIOLOGY, PersonKey.LENNOX_YOUNG, 10, null!),
  [ScienceKey.GENETIC_MEMORY]: new Unlock(UnlockKey.SCIENCE, ScienceKey.GENETIC_MEMORY, PersonKey.LENNOX_YOUNG, 10, null!),
  [ScienceKey.TELOMERE_STRETCHER]: new Unlock(UnlockKey.SCIENCE, ScienceKey.TELOMERE_STRETCHER, PersonKey.LENNOX_YOUNG, 10, null!),
  [ScienceKey.THE_FLUID]: new Unlock(UnlockKey.SCIENCE, ScienceKey.THE_FLUID, PersonKey.LENNOX_YOUNG, 10, null!),

  [ScienceKey.ALCHEMY]: new Unlock(UnlockKey.SCIENCE, ScienceKey.ALCHEMY, PersonKey.SAMA, 10, null!),
  [ScienceKey.CHRONOMOGRIFICATION]: new Unlock(UnlockKey.SCIENCE, ScienceKey.CHRONOMOGRIFICATION, PersonKey.SAMA, 10, null!),
  [ScienceKey.DISTILLER]: new Unlock(UnlockKey.SCIENCE, ScienceKey.DISTILLER, PersonKey.SAMA, 10, null!),
  [ScienceKey.ELEMENT_ZERO]: new Unlock(UnlockKey.SCIENCE, ScienceKey.ELEMENT_ZERO, PersonKey.SAMA, 10, null!),

  [ScienceKey.MATHEMATICS]: new Unlock(UnlockKey.SCIENCE, ScienceKey.MATHEMATICS, PersonKey.ITOTIA, 10, null!),
  [ScienceKey.TIMELESS_ALGEBRA]: new Unlock(UnlockKey.SCIENCE, ScienceKey.TIMELESS_ALGEBRA, PersonKey.ITOTIA, 10, null!),
  [ScienceKey.NEPOHUALTZINTZIN]: new Unlock(UnlockKey.SCIENCE, ScienceKey.NEPOHUALTZINTZIN, PersonKey.ITOTIA, 10, null!),
  [ScienceKey.OBSIDIAN]: new Unlock(UnlockKey.SCIENCE, ScienceKey.OBSIDIAN, PersonKey.ITOTIA, 10, null!),

  [ScienceKey.ASTRONOMY]: new Unlock(UnlockKey.SCIENCE, ScienceKey.ASTRONOMY, PersonKey.NECHTAN, 10, null!),
  [ScienceKey.AETHERIC_HOROSCOPES]: new Unlock(UnlockKey.SCIENCE, ScienceKey.AETHERIC_HOROSCOPES, PersonKey.NECHTAN, 10, null!),
  [ScienceKey.ZODIAC_TALISMAN]: new Unlock(UnlockKey.SCIENCE, ScienceKey.ZODIAC_TALISMAN, PersonKey.NECHTAN, 10, null!),
  [ScienceKey.SARSEN_STONES]: new Unlock(UnlockKey.SCIENCE, ScienceKey.SARSEN_STONES, PersonKey.NECHTAN, 10, null!),

  [DeviceKey.CRYSTAL_SARCOPHAGUS]: new Unlock(UnlockKey.DEVICE, DeviceKey.CRYSTAL_SARCOPHAGUS, PersonKey.LENNOX_OLD, 10, null!),
  [DeviceKey.OMEGAPERSON]: new Unlock(UnlockKey.DEVICE, DeviceKey.OMEGAPERSON, PersonKey.LENNOX_YOUNG, 10, null!),
  [DeviceKey.PHILOSOPHERS_STONE]: new Unlock(UnlockKey.DEVICE, DeviceKey.PHILOSOPHERS_STONE, PersonKey.SAMA, 10, null!),
  [DeviceKey.TZOLKIN]: new Unlock(UnlockKey.DEVICE, DeviceKey.TZOLKIN, PersonKey.ITOTIA, 10, null!),
  [DeviceKey.TIMEHENGE]: new Unlock(UnlockKey.DEVICE, DeviceKey.TIMEHENGE, PersonKey.NECHTAN, 10, null!),
});
